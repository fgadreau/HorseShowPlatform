...
environment_file="$HOME/.config/showscore-relay.env"
...
echo "Le service restera installé et activé après les redémarrages."
echo "Lancez-la depuis le dossier Applications Linux de ChromeOS."
