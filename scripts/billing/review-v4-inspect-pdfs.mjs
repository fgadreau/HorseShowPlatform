...
const dir='.tmp/review-v4',manifest=JSON.parse(readFileSync(dir+'/documents-results.json'));mkdirSync(dir+'/pdf-images',{recursive:true});let checks=0;const files=[];
