...
const child=spawn('.tmp/billing-pilot/stripe-cli/node_modules/.bin/stripe',['--config','.tmp/billing-pilot/stripe-cli-config.toml','listen','--skip-update','--events','payment_intent.succeeded,payment_intent.processing,payment_intent.payment_failed,payment_intent.canceled,payment_intent.requires_action,payment_intent.amount_capturable_updated','--forward-to','http://127.0.0.1:54331/webhook'],{env:{...process.env,STRIPE_API_KEY:key},stdio:['ignore','pipe','pipe']});
