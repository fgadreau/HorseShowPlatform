...
try{
 for(const kind of ['statement','receipt','invoice'])for(const locale of ['fr','en']){
  const d=fixture(kind),s=d.snapshot;s.render_version=2;s.payments.forEach((p,i)=>p.receipt_number='DEMO-REC-'+(i+1));s.suppliers={association:{name:'Association DEMO',address:'1 rue Fictive',tax_number_1:'DEMO-ASSO-TAX'},hsp:{name:'HSP DEMO',address:'2 rue Fictive',tax_number_1:'DEMO-HSP-TAX'}};s.mandate='DEMO mandate — unvalidated tax prototype';
