...
const container='supabase_db_hsp-vet-local',dir='.tmp/billing-pilot';
...
const tables=['invoices','payments','contacts','horses','entries','stall_bookings'];
...
for(const name of ['20260906000900_billing_folio_foundation.sql','20260906001000_billing_checkout_server.sql','20260906001100_billing_stripe_test.sql','20260906001200_billing_ui_contracts.sql','20260906001300_billing_document_pdf.sql']){
