...
Le dernier job utilise l'environnement GitHub `Production` et exige le secret
`PRODUCTION_DATABASE_URL`. Ce secret doit être une connexion directe ou poolée
à la base PROD, conservée uniquement dans l'environnement GitHub protégé.
